...
- [Storybook Legacy (\<v8)](/quickstart/legacy-storybook).
...
Argos supports Story modes to capture different states of your components. Read our [Story modes guide](/docs/storybook-story-modes) for more details.
...
Also supports all options from the [Playwright `argosScreenshot` function](/docs/playwright#argosscreenshotpage-name-options) and [upload parameters](https://js-sdk-reference.argos-ci.com/interfaces/UploadParameters.html).
